...
class _AppState extends State<App>
{
    ...
    else if(toDraw == 1)
      {
      ...
      else if(toDraw == 2)
        {
          ...
          return new Center(
              child: new Column(
                children: <Widget>[
                  new Text("Could not read the barcode properly. ISBN read - $barcode", textScaleFactor: 1.6,),
                  new TextField(controller: textEditingController, decoration: new InputDecoration(labelText: "ISBN", hintText: "Type in the ISBN number"),
                                keyboardType: TextInputType.number,),
                  new RaisedButton(onPressed: _buttonPressed, child: new Text("Submit")),
                ],
              ),
          );
        }
  ...
  Widget build(BuildContext context)
  {
      ...
      return new MaterialApp(
        ...
        home: new Scaffold(
          key: _scaffoldKey,
          appBar: new AppBar(title: new Text("Book Info"),
          actions: <Widget>[
...
//                keyboardType: TextInputType.number,),
                new Center(
                    child: new RaisedButton(onPressed: scan, child: new Text("Scan"))
                ),
                new Padding(
                  padding: const EdgeInsets.all(10.0),
                  child: _formResult(),
