...
class Scraper
{
  String url = "http://gen.lib.rus.ec/search.php?lg_topic=libgen&open=0&view=simple&res=25&phrase=0&column=title&req=";
  String title;
  ...
  Future<String> _getFirstResult() async
  {
    ...
    await http.read(url).then((r)
    {
      ...
      var attrs = table.getElementsByTagName('tr')[1].getElementsByTagName('td')[9].getElementsByTagName('a')[0].attributes;
